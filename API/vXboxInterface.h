...
extern "C"
{
	...
	VXBOX_API BOOL	__cdecl	 SetBtnThumbL(UINT UserIndex, BOOL Press); // Left Thumb/Stick
	VXBOX_API BOOL	__cdecl	 SetBtnThumbR(UINT UserIndex, BOOL Press); // Right Thumb/Stick
	VXBOX_API BOOL	__cdecl	 SetBtnShoulderL(UINT UserIndex, BOOL Press); // Left Bumper
	VXBOX_API BOOL	__cdecl	 SetBtnShoulderR(UINT UserIndex, BOOL Press); // Right Bumper
	...
	VXBOX_API BOOL	__cdecl	 SetAxisLx(UINT UserIndex, SHORT Value); // Left Stick X
	VXBOX_API BOOL	__cdecl	 SetAxisLy(UINT UserIndex, SHORT Value); // Left Stick Y
